...
:parameters ()
:precondition (and (not-made p2)(started o8))
...
:parameters ()
:precondition (and (not-made p4)(started o12))
:effect (and (not (not-made p4)) (made p4))
)

(:action make-product-p5
:parameters ()
:precondition (and (not-made p5)(started o10))
...
:parameters ()
:precondition (and (not-made p8)(started o11)(started o13))
:effect (and (not (not-made p8)) (made p8))
)

(:action make-product-p9
:parameters ()
:precondition (and (not-made p9)(started o6)(started o13))
:effect (and (not (not-made p9)) (made p9))
)

(:action make-product-p10
:parameters ()
:precondition (and (not-made p10)(started o3))
:effect (and (not (not-made p10)) (made p10))
)

(:action make-product-p11
:parameters ()
:precondition (and (not-made p11)(started o7)(started o10))
...
:parameters ()
:precondition (and (not-made p14)(started o1))
:effect (and (not (not-made p14)) (made p14))
)

(:action ship-order-o1
:parameters (?avail ?new-avail - count)
:precondition (and (started o1)(made p14)(stacks-avail ?avail)(next-count ?avail ?new-avail))
...
:parameters (?avail ?new-avail - count)
:precondition (and (started o3)(made p3)(made p10)(stacks-avail ?avail)(next-count ?avail ?new-avail))
...
:parameters (?avail ?new-avail - count)
:precondition (and (started o7)(made p3)(made p6)(made p7)(made p11)(stacks-avail ?avail)(next-count ?avail ?new-avail))
...
:parameters (?avail ?new-avail - count)
:precondition (and (started o10)(made p5)(made p11)(stacks-avail ?avail)(next-count ?avail ?new-avail))
...
:parameters (?avail ?new-avail - count)
:precondition (and (started o12)(made p4)(made p6)(stacks-avail ?avail)(next-count ?avail ?new-avail))
:effect (and (not (started o12))(shipped o12)(not (stacks-avail ?avail))(stacks-avail ?new-avail)))

(:action ship-order-o13
:parameters (?avail ?new-avail - count)
:precondition (and (started o13)(made p8)(made p9)(made p12)(made p13)(stacks-avail ?avail)(next-count ?avail ?new-avail))
