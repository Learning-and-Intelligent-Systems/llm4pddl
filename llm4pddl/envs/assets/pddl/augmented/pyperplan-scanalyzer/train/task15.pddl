(define (problem scanalyzer3d-54)
  ...
  (:goal (and (analyzed car-in-1a) (analyzed car-in-1b) (analyzed car-out-1a) (analyzed car-out-1b) (on car-in-1a seg-out-1b) (on car-in-1b seg-in-1a) (on car-out-1b seg-out-1a)))
)
