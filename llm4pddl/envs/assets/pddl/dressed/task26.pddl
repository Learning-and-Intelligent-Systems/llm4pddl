(define (problem dressed)
  (:domain dressed)
  (:objects person1 person2 person3 person4 person5 person6 person7 person8 person9 person10 person11 person12 person13 - person
  ...
  (:goal (and (attending-formal-event person13)
