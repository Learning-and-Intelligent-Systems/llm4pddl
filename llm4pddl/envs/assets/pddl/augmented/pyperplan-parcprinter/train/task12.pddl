(define (problem printjob)
  ...
  (:goal (and (hasimage sheet1 front image-1) (notprintedwith sheet1 front color) (notprintedwith sheet1 back color) (sideup sheet1 front) (stackedin sheet1 finisher1_tray)))
)
