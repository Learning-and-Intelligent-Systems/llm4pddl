...
class CustomEnv(BaseEnv):
    ...
    def __init__(self, benchmark_name: str) -> None:
        ...
        self._train_tasks = [utils.get_custom_task(benchmark_name, i) for i in train_task_nums]
        self._eval_tasks = [utils.get_custom_task(benchmark_name, i) for i in eval_task_nums]
