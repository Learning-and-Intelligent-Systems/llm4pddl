(define (problem printjob)
  ...
  (:goal (and (notprintedwith sheet1 front color) (notprintedwith sheet1 back black) (notprintedwith sheet1 back color) (sideup sheet1 front) (stackedin sheet1 finisher1_tray)))
)
